...
A [timoni.sh](http://timoni.sh) module for deploying rpk-shell to Kubernetes clusters.
...
```shell
timoni -n default apply rpk-shell oci://ghcr.io/anthonybrice/modules/rpk-shell
```
...
```shell
timoni -n default apply rpk-shell oci://ghcr.io/anthonybrice/rpk-shell \
...
```shell
timoni -n default delete rpk-shell
```
...
| `image: repository:`     | `string`                         | `ghcr.io/anthonybrice/rpk-ctr`  | Container image repository                                                                                                                   |
