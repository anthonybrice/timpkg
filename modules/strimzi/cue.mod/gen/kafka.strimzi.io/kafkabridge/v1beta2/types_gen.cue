...
#KafkaBridgeSpec: {
	...
	consumer?: {
		// The Kafka consumer configuration used for consumer instances
		// created by the bridge. Properties with the following prefixes
		// cannot be set: ssl., bootstrap.servers, group.id, sasl.,
	...
	// the image specified in the Cluster Operator configuration. If
	...
	producer?: {
		// The Kafka producer configuration used for producer instances
		// created by the bridge. Properties with the following prefixes
		// cannot be set: ssl., bootstrap.servers, sasl., security. (with
		// the exception of: ssl.endpoint.identification.algorithm,
	...
	// Template for Kafka Bridge resources. The template allows users
	// to specify how a `Deployment` and `Pod` is generated.
	template?: {
