...
#KafkaMirrorMaker2Spec: {
	...
	clusters?: [...{
		...
		// The MirrorMaker 2 cluster config. Properties with the following
	...
	// The cluster alias used for Kafka Connect. The value must match
	// the alias of the *target* Kafka cluster as specified in the
	// `spec.clusters` configuration. The target Kafka cluster is
	// used by the underlying Kafka Connect framework for its
	// internal topics.
	...
	mirrors?: [...{
		// The specification of the Kafka MirrorMaker 2 checkpoint
		// connector.
		checkpointConnector?: {
		...
		// A regular expression matching the consumer groups to exclude
		...
		// A regular expression matching the consumer groups to be
		// mirrored. Comma-separated lists are also supported.
		...
		// The alias of the source cluster used by the Kafka MirrorMaker 2
		// connectors. The alias must match a cluster in the list at
		// `spec.clusters`.
		...
		// The alias of the target cluster used by the Kafka MirrorMaker 2
		// connectors. The alias must match a cluster in the list at
		// `spec.clusters`.
		targetCluster: string

		// A regular expression matching the topics to exclude from
		// mirroring. Comma-separated lists are also supported.
		...
		// A regular expression matching the topics to be mirrored, for
		// example, "topic1\|topic2\|topic3". Comma-separated lists are
		// also supported.
